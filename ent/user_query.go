...
func (_q *UserQuery) QueryAccessToken() *TokenQuery {
	...
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		...
		step := sqlgraph.NewStep(
			...
			sqlgraph.Edge(sqlgraph.O2O, false, user.AccessTokenTable, user.AccessTokenColumn),
		)
...
func (_q *UserQuery) Clone() *UserQuery {
	...
	return &UserQuery{
		...
		withAccessToken: _q.withAccessToken.Clone(),
...
func (_q *UserQuery) WithAccessToken(opts ...func(*TokenQuery)) *UserQuery {
	query := (&TokenClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	_q.withAccessToken = query
	return _q
}
...
func (_q *UserQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*User, error) {
	...
	if query := _q.withAccessToken; query != nil {
		if err := _q.loadAccessToken(ctx, query, nodes, nil,
			func(n *User, e *Token) { n.Edges.AccessToken = e }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *UserQuery) loadAccessToken(ctx context.Context, query *TokenQuery, nodes []*User, init func(*User), assign func(*User, *Token)) error {
	...
	query.Where(predicate.Token(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(user.AccessTokenColumn), fks...))
	}))
